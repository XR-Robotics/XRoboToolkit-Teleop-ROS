...
int main(int argc, char **argv)
{
    ...
    // Publisher to ARX
    ros::Publisher left_pub = n.advertise<pos_cmd_msg::PosCmd>("/ARX_VR_L", 10);
    ros::Publisher right_pub = n.advertise<pos_cmd_msg::PosCmd>("/ARX_VR_R", 10);
    ...
    while (ros::ok())
    {
      ...
      if (true) {
        ...
        // ROS_INFO("Published Left PosCmd message: x=%f, y=%f, z=%f", left_msg.x, left_msg.y, left_msg.z);
        // ROS_INFO("Published Right PosCmd message: x=%f, y=%f, z=%f", right_msg.x, right_msg.y, right_msg.z);
      }
      ros::spinOnce();
      loop_rate.sleep();
    }
